...
export function BankAccountsTab() {
    ...
    const { data: rawAccounts, isLoading: accountsLoading } =
        api.bankAccount.list.useQuery();
        ...
        <Card className="overflow-hidden">
            ...
            <Dialog open={editOpen} onOpenChange={(o) => !o && closeEdit()}>
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle>
                            {isCreating ? "Adicionar conta" : "Editar conta"}
                        </DialogTitle>
                        <DialogDescription>
                            Configure os dados da conta bancária ou cartão.
                        </DialogDescription>
                    </DialogHeader>
                ...
                <AlertDialogContent>
                    ...
                    <AlertDialogFooter>
                        ...
                        <AlertDialogAction
                            onClick={() =>
                                confirmDeleteId &&
                                deleteAccount.mutate({ id: confirmDeleteId })
                            }
            ...
            {active ? (
                        ...
                        <div className="text-left sm:text-right">
                            ...
                            <p
                                className={`text-2xl font-semibold ${
                                    Number(active.currentBalance) < 0
                                        ? "text-destructive"
                                        : "text-foreground"
                                }`}
                            >
                ...
                <CardContent className="py-12 text-center text-sm text-muted-foreground">
                    Selecione ou adicione uma conta para visualizar suas
                    transações.
                </CardContent>
            )}
        </Card>
