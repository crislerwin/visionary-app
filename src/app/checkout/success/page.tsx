...
import { ArrowLeft, CheckCircle, ChefHat, Clock, Home, Package, Truck } from "lucide-react";
    ...
    <div className="container mx-auto max-w-2xl px-4 py-8">
      <Card className="text-center">
        <CardHeader>
          ...
          <CardDescription>Seu pedido foi recebido e está sendo processado</CardDescription>
        </CardHeader>
